...
def afficher_le_statut_complet():
    ...
    print(" FAIM      : " + str(niveau_de_faim) + " / 100")
    print("-------------------------------------------------------")
...
def lancer_un_combat(nom_du_monstre, pv_du_monstre, force_du_monstre, est_un_boss, attaques_speciales=[]):
    global sante_actuelle, est_en_vie, nombre_de_chairs, nombre_de_conserves
...
while est_en_vie == True:
    ...
    if choix_menu == "1":
        ...
        # police
            ...
            if policier_secouru == False:
                ...
                time.sleep(1)
                resultat_combat = lancer_un_combat("Zombie de Garde", 55, 30, False)  
                ...
                lancer_un_combat("Zombie Errant", 50, 22, False)  
        ...
        # boulangerie
            ...
            if boulanger_satisfait == False:
                ...
                if choix_boulangerie == "1":
                    ...
                    resultat1 = lancer_un_combat("Zombie Boulanger", 70, 0, False, attaques_boulanger)
                    ...
                    if resultat1 == "victoire" or resultat1 == "fuite":
                        ...
                        resultat2 = lancer_un_combat("Zombie Livreur", 55, 0, False, attaques_livreur)
        ...
        # tram dépot
            ...
            if "Casque de chantier" in mon_sac_a_dos:
                ...
                print(f"Tu gagnes +{bonus_casque} points de protection contre l'agent")
                time.sleep(1)
            ...
            while pv_boss > 0 and sante_actuelle > 0:
                ...
                print("3. Tu tentes une esquive")
                
                choix = input("\nTon choix : ")
                esquive_active = False

                if choix == "1":
                    degats_donnes = random.randint(15, 20) + degats_arme
                    pv_boss -= degats_donnes
                    print(f"Touché, il perd {degats_donnes} PV.")
                
                elif choix == "2":
                    chance = random.randint(1, 2)
                    if chance == 1:
                        degats_donnes = (random.randint(20, 30) + degats_arme) * 2
                        pv_boss -= degats_donnes
                        print(f"BAHHAHAHAHAH, dans son crane, il perd {degats_donnes} PV !")
                    else:
    ...
    # sac
        ...
        if choix_sac == "1" and "Fusil d'assaut" in mon_sac_a_dos:
            ...
            nombre_de_conserves = nombre_de_conserves - 1
            niveau_de_faim = niveau_de_faim - 25  
            if niveau_de_faim < 0:
                niveau_de_faim = 0
            ...
            print("Il te protégera lors des prochains combats tu suppposes")
    ...
    if niveau_de_faim >= 60:
        print("\nTu es affamé")
        
    if niveau_de_faim >= 80:
        sante_actuelle -= 10
        print("\nTU POURRAIS PENSER A TON VENTRE UN PEU??? MANGE")    
        
    if niveau_de_faim >= 100:
